...
count_perebor=0
#метод последовательного перехода
...
count_random=1
#метод случайного разгадывания
y=randint(0,100)
while x!=y:
    y=randint(0,100)
    count_random+=1

#print("Загаданное число было ",x, " и для его поиска перебором потребовалось ", count_random, " итераций")
